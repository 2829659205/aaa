...
　应用说明:页面包含<script type="text/javascript" src="pcasunzip.js"/*tpa=http://static.mingchao.com/official/js/pcasunzip.js*/ charset="gb2312"></script>
	省市联动
...
PCAS.SetP = function(PCA) {
	//与原版相比，在每次插入options时移除旧options
	for(var i=0;i<PCA.SelP.options.length;) { 
		PCA.SelP.removeChild(PCA.SelP.options[i]); 
	}
